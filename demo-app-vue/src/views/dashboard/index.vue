<template>
	<div class="wrapper">
		<a-row :gutter="[16,16]">
			...
			<a-col :span="14">
				<a-card :bordered="false">
                    <div class="card-header"><span class="iconfont iconqushi"></span>近七天浏览</div>
					<div style="height: 300px;width:100%" ref="echarsLine"></div>
				</a-card>
			</a-col>
			<a-col :span="10">
				<a-card :bordered="false">
                    <div class="card-header"><span class="iconfont icondiyufenbu"></span>地区分布</div>
					<div style="height: 300px;width:100%" ref="FAndCForFlag"></div>
				</a-card>
			</a-col>
			<a-col :span="24">
				<a-card :bordered="false">
                    <div class="card-header"><span class="iconfont iconicon"></span>访问记录</div>
					<a-table 
                    class="box-table"
                    :columns="columns" 
                    :data-source="data"
...
export default {
	...
	methods: {
		...
		initEchars() {
			let data = [
				{ name: 'Bulk Carrier', value: 18 },
				{ name: 'LNG', value: 24 },
				{ name: 'Oil Tanker', value: 58 },
			]
			console.log('initEchars:')
			let options = {
				color: [
